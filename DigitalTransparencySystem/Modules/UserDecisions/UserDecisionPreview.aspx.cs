...
{
    public partial class UserDecisionPreview : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!int.TryParse(Request.QueryString["id"], out decisionID)
                && !int.TryParse(Request.QueryString["DecisionID"], out decisionID))
            {
