<%@ Page Title="Edit Decision | DTAS" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" Codebehind="EditDecision.aspx.cs" Inherits="DigitalTransparencySystem.Modules.Decisions.EditDecision" %>
    ...
    <div class="flex min-h-screen">
        ...
        <main class="dashboard-main flex-1 ml-64 p-8">
            ...
            <nav class="flex items-center gap-2 mb-6 font-label-md text-label-md text-on-surface-variant">
                ...
                <span class="material-symbols-outlined text-[16px]">chevron_right</span>
                <span class="text-primary font-semibold">Edit Decision</span>
            </nav>

            <!-- Header Section -->
            <header class="flex justify-between items-end mb-8">
                <div>
                    <h1 class="font-headline-lg text-headline-lg text-primary mb-2">Edit Decision</h1>
                    <p class="font-body-lg text-body-lg text-on-surface-variant max-w-2xl">Update the details of this governance decision.</p>
                </div>
            ...
            <!-- Success Message -->
            <asp:Panel ID="pnlSuccess" runat="server" CssClass="mb-6 p-4 bg-[rgba(46,125,50,0.1)] border border-[#2e7d32]/30 rounded-xl flex items-center gap-3" Visible="false">
            ...
            <div class="glass-card rounded-xl p-8">
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <asp:RequiredFieldValidator ID="rfvDecisionTitle" runat="server" ControlToValidate="txtDecisionTitle" ErrorMessage="Decision title is required." CssClass="text-error text-sm mt-1 block" Display="Dynamic" ValidationGroup="EditDecision"></asp:RequiredFieldValidator>
                    </div>
                    ...
                    <div>
                        ...
                        <asp:RequiredFieldValidator ID="rfvDescription" runat="server" ControlToValidate="txtDescription" ErrorMessage="Description is required." CssClass="text-error text-sm mt-1 block" Display="Dynamic" ValidationGroup="EditDecision"></asp:RequiredFieldValidator>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <asp:DropDownList ID="ddlPriority" runat="server" CssClass="w-full px-4 py-3 bg-surface-container-low border border-outline rounded-lg font-body-md text-body-md focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all appearance-none" ValidationGroup="EditDecision">
                            ...
                            <asp:RequiredFieldValidator ID="rfvPriority" runat="server" ControlToValidate="ddlPriority" InitialValue="" ErrorMessage="Priority is required." CssClass="text-error text-sm mt-1 block" Display="Dynamic" ValidationGroup="EditDecision"></asp:RequiredFieldValidator>
                        </div>
                        <div>
                            <label class="block font-label-md text-label-md text-on-surface-variant mb-2">Status <span class="text-error">*</span></label>
                            <asp:DropDownList ID="ddlStatus" runat="server" CssClass="w-full px-4 py-3 bg-surface-container-low border border-outline rounded-lg font-body-md text-body-md focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all appearance-none" ValidationGroup="EditDecision">
                            ...
                            <asp:RequiredFieldValidator ID="rfvStatus" runat="server" ControlToValidate="ddlStatus" InitialValue="" ErrorMessage="Status is required." CssClass="text-error text-sm mt-1 block" Display="Dynamic" ValidationGroup="EditDecision"></asp:RequiredFieldValidator>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <asp:RequiredFieldValidator ID="rfvResponsiblePerson" runat="server" ControlToValidate="ddlResponsiblePerson" InitialValue="" ErrorMessage="Responsible person is required." CssClass="text-error text-sm mt-1 block" Display="Dynamic" ValidationGroup="EditDecision"></asp:RequiredFieldValidator>
                        </div>
                        <div></div>
                    </div>
                    ...
                    <div class="flex items-center gap-4 pt-4 border-t border-outline-variant/30">
                        <asp:Button ID="btnUpdate" runat="server" Text="Save Changes" CssClass="px-8 py-3 bg-primary text-on-primary rounded-xl font-label-md text-label-md font-bold active:scale-95 transition-transform cursor-pointer" ValidationGroup="EditDecision" OnClick="btnUpdate_Click" />
