...
{
    public partial class UserTopbar : UserControl
    {
        private string connectionString;

        protected void Page_Load(object sender, EventArgs e)
        {
            AuthService.RememberHomePortal(Session, false);
        ...
        private void ApplySuspendedChrome()
        {
            if (!AuthService.IsSuspendedViewOnly(Session))
            {
                lnkMarkAllRead.Enabled = true;
                return;
            }

            lnkMarkAllRead.Enabled = false;
            Page.ClientScript.RegisterStartupScript(GetType(), "dtasSuspended",
