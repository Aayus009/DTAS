<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UserTopbar.ascx.cs" Inherits="DigitalTransparencySystem.MasterPages.UserTopbar" %>
...
<nav class="dashboard-topbar dtas-topbar w-full z-50 bg-surface/90 backdrop-blur-md border-b border-surface-container-high">
    <div class="dtas-topbar-left">
        <button type="button" id="btnUserSidebarToggle" class="sidebar-toggle material-symbols-outlined text-on-surface-variant" onclick="toggleUserSidebar()">menu</button>
    ...
    <div class="dtas-search" data-search-url="<%= ResolveUrl("~/Modules/Search/GlobalSearch.ashx") %>">
        <label class="dtas-search-field">
            ...
            <input type="search" class="js-dtas-search dtas-search-input" placeholder="Search tasks, meetings, events..." autocomplete="off" />
    ...
    <div class="dtas-topbar-right">
        ...
        <!-- Settings -->
        <asp:HyperLink ID="lnkSettings" runat="server" NavigateUrl="~/Modules/Settings/UserProfile.aspx"
        ...
        <div class="relative">
            ...
            <div id="profileDropdown" class="hidden absolute right-0 mt-2 w-64 bg-surface-container-lowest border border-outline-variant rounded-xl shadow-lg overflow-hidden z-50">
                ...
                <div class="py-1">
                    <asp:HyperLink ID="lnkProfile" runat="server" NavigateUrl="~/Modules/Settings/UserProfile.aspx"
                    ...
                    <asp:HyperLink ID="lnkSettingsMenu" runat="server" NavigateUrl="~/Modules/Settings/UserProfile.aspx"
                        CssClass="flex items-center gap-3 px-4 py-2.5 text-on-surface hover:bg-surface-container-low transition-colors text-label-md">
